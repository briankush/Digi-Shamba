...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* IMPORTANT: No navbar in this component - rely on the global navbar */}
      {/* Content section with tabs */}
      <div className="container mx-auto px-4 pt-20"> {/* Added pt-20 for space below global navbar */}
        <div className="mb-6 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-green-800">{typedMsg}</h1>
          <div className="flex space-x-2">
            <button 
              onClick={() => setActiveTab("dashboard")}
              className={`px-4 py-2 rounded-md ${activeTab === "dashboard" ? "bg-green-700 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}
            >
              Dashboard
            </button>
            <button 
              onClick={() => setActiveTab("users")}
              className={`px-4 py-2 rounded-md ${activeTab === "users" ? "bg-green-700 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}
            >
              Users
            </button>
            <button 
              onClick={() => setActiveTab("animals")}
              className={`px-4 py-2 rounded-md ${activeTab === "animals" ? "bg-green-700 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}
            >
              Animals
            </button>
          </div>
